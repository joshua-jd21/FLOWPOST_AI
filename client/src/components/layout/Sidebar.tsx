    ...
    <>
      ...
      <aside className="hidden w-64 flex-shrink-0 border-r border-gray-200 bg-white lg:flex lg:flex-col">
        ...
        <div className="flex h-16 items-center gap-2 border-b border-gray-100 px-6">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-r from-indigo-600 to-violet-500 text-sm font-bold text-white">
            F
          </div>
        ...
        <div className="border-t border-gray-100 p-4">
          <p className="text-xs text-gray-400">FlowPost AI v0.1</p>
        </div>
      </aside>
